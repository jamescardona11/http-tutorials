...
import 'package:firebase_filledstacks_app/ui/shared/shared_styles.dart' as sharedStyles;
...
class _ExpansionListState extends State<ExpansionList> {
  ...
  Widget build(BuildContext context) {
    return AnimatedContainer(
      ...
      height: expanded ? expandedHeight : widget.smallVersion ? sharedStyles.smallFieldHeight : startingHeight,
  ...
  void _calculateExpandedHeight() {
    expandedHeight = 2 +
        (widget.smallVersion ? sharedStyles.smallFieldHeight : sharedStyles.fieldHeight) +
        (widget.items.length * (widget.smallVersion ? sharedStyles.smallFieldHeight : sharedStyles.fieldHeight));
  }
}
